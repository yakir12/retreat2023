...
## Bare minimum
We need:
- to convert the image from pixel coordinates to angular coordinates
- the angular resolution of the animal's visual system (e.g. the FWHM° of the Point Spread Function)
...
# ╔═╡ 803a262e-2196-480f-b69a-c22f91ffd2a0
md"Each pixel is $(@bind Δ Slider((1:180) ./ w, show_value=true)) degrees."

# ╔═╡ 99f9bf1f-ed4b-4871-b381-80b3ca11f10f
md"The FWHM of the Point Spread Function of the visual system is $(@bind FWHM Slider(0.01:0.1:10, show_value=true)) degrees."

# ╔═╡ bca2c9b0-785c-4949-8797-56816a539ae5
md"In pixels the FWHM would be $(FWHM_in_pixels = min(w / 2, FWHM / Δ))."

# ╔═╡ 295b2cf0-7191-4a3a-8240-bc83ea2d5298
md"The standard deviation of the PSF is therefore $(σ = FWHM_in_pixels / 2sqrt(2log(2))) pixels."

# ╔═╡ 4792607f-556e-4544-8142-0f8752a43281
plot(Normal(0, σ), legend = false, xlims=(-30, 30), ylims=(0, Inf), xlabel="Angular deviation (°)", ylabel="Density")

# ╔═╡ c189c232-208e-4093-aa82-5a2d9bf83e0e
md"We convolve the image with a Gaussian filter with the same σ:"

# ╔═╡ e28ea8c3-2521-45b6-85ec-19bec8c444f0
imgf = imfilter(img, Kernel.gaussian(σ))
